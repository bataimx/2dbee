...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"REez":[function(require,module,exports) {
"use strict";
...
},{}],"Snzt":[function(require,module,exports) {
"use strict";
...
var _default = k;
exports.default = _default;
},{"../node_modules/kaboom/dist/kaboom.mjs":"REez"}],"FZQ6":[function(require,module,exports) {
"use strict";
...
function addBackground() {
  _kaboom.default.add([_kaboom.default.sprite('bg'), _kaboom.default.scale(_kaboom.default.width() / 240, _kaboom.default.height() / 240), _kaboom.default.layer('bg')]);
}

function addBirdy(config) {
  var _config$flySpeed = config.flySpeed,
      flySpeed = _config$flySpeed === void 0 ? 0.5 : _config$flySpeed,
      _config$isSolid = config.isSolid,
      isSolid = _config$isSolid === void 0 ? false : _config$isSolid;
  var useBody = isSolid ? _kaboom.default.solid() : _kaboom.default.body();

  var birdy = _kaboom.default.add([_kaboom.default.sprite('honey', {
    animSpeed: flySpeed,
    frame: 0
  }), _kaboom.default.area(_kaboom.default.vec2(0, 20), _kaboom.default.vec2(45)), _kaboom.default.layer('obj'), _kaboom.default.pos(_kaboom.default.width() / 4, _kaboom.default.height() / 2), useBody]);

  birdy.scale = _kaboom.default.vec2(0.4);
  birdy.play('fly');
  return birdy;
}
...
function tileMap() {
  return {
    goldCoin: _kaboom.default.sprite('tileMap', {
      frame: 78
    }),
    bigGoldCoin: _kaboom.default.sprite('tileMap', {
      frame: 179
    }),
    heart: _kaboom.default.sprite('tileMap', {
      frame: 373
    }),
    blackBird: _kaboom.default.sprite('tileMap', {
      frame: 441,
      animSpeed: 0.09
    }),
    blackBee: _kaboom.default.sprite('tileMap', {
      frame: 320,
      animSpeed: 0.02
    }),
    frog: _kaboom.default.sprite('tileMap', {
      frame: 418
    })
  };
}
},{"../kaboom":"Snzt"}],"JjQI":[function(require,module,exports) {
"use strict";
...
var ActionBase = /*#__PURE__*/function () {
  ...
  _createClass(ActionBase, [{
    key: "execute",
    value: function execute(p) {
      if (p.pos.x < -_kaboom.default.width() / 2) {
        _kaboom.default.destroy(p);
      }
    }
  }, {
    key: "checkIsPaused",
    value: function checkIsPaused() {
...
},{"../kaboom":"Snzt"}],"S9JN":[function(require,module,exports) {
"use strict";
...
var _common = require("../scenes/common");
...
var BirdFly = /*#__PURE__*/function (_ActionBase) {
  _inherits(BirdFly, _ActionBase);

  var _super = _createSuper(BirdFly);
  ...
  _createClass(BirdFly, [{
    key: "execute",
    value: function execute(p) {
      var middleY = _kaboom.default.height() / 2;
      var _p$flySpeed = p.flySpeed,
          flySpeed = _p$flySpeed === void 0 ? 0.01 : _p$flySpeed,
          _p$moveSpeed = p.moveSpeed,
          moveSpeed = _p$moveSpeed === void 0 ? 2 : _p$moveSpeed,
          _p$defaultPos = p.defaultPos;
      _p$defaultPos = _p$defaultPos === void 0 ? {} : _p$defaultPos;
      var _p$defaultPos$y = _p$defaultPos.y,
          defaultPosY = _p$defaultPos$y === void 0 ? middleY : _p$defaultPos$y;
      var x = p.pos.x;
      var r = 20;
      var y = defaultPosY + r * Math.sin(x * flySpeed);
      p.pos.y = y;
      p.move(-(_common.SPEED * moveSpeed), 0);

      _get(_getPrototypeOf(BirdFly.prototype), "execute", this).call(this, p);
    }
  }]);
...
exports.default = BirdFly;
},{"../kaboom":"Snzt","../scenes/common":"FZQ6","./actionBase":"JjQI"}],"ZG0O":[function(require,module,exports) {
"use strict";
...
var MoveAction = /*#__PURE__*/function (_ActionBase) {
  _inherits(MoveAction, _ActionBase);

  var _super = _createSuper(MoveAction);
  ...
  _createClass(MoveAction, [{
    key: "execute",
    value: function execute(p) {
      p.move(-_common.SPEED, 0);

      _get(_getPrototypeOf(MoveAction.prototype), "execute", this).call(this, p);
    }
  }]);
...
},{"../scenes/common":"FZQ6","./actionBase":"JjQI"}],"JjTe":[function(require,module,exports) {
"use strict";
...
var _birdFly = _interopRequireDefault(require("../actions/birdFly"));

var _moveAction = _interopRequireDefault(require("../actions/moveAction"));
...
function mainScene() {
  ...
  this.isPaused = false;
  this.bgMusic = _kaboom.default.play('bgMusic', {
    volume: 0.3,
    loop: true
  }); // define gravity

  _kaboom.default.gravity(gravity);

  _kaboom.default.layers(['bg', 'point', 'obj', 'blackBird', 'ui'], 'obj');

  (0, _common.addBackground)();
  this.birdy = (0, _common.addBirdy)({
    flySpeed: flySpeed
  });
  var score = addScore();
  this.birdy.action(function () {
    if (_this.birdy.pos.y >= _kaboom.default.height() || _this.birdy.pos.y <= CEILING) {
      deathScene(_this, score);
    }
  });
  ...
  _kaboom.default.keyPress('space', function () {
    ...
    _this.birdy.jump(JUMP_FORCE);

    _kaboom.default.play('jump');
  });
  ...
  this.birdy.collides('pipe', function () {
    deathScene(_this, score);
  });
  this.birdy.collides('blackBird', function () {
    deathScene(_this, score);
  });
  this.birdy.collides('point', function (p) {
    if (_this.isPaused) {
      return;
    }
  ...
  var moveAction = new _moveAction.default(this);
  var blackBirdFly = new _birdFly.default(this);

  _kaboom.default.action('pipe', function (p) {
    moveAction.run(p);
  });

  _kaboom.default.action('point', function (p) {
    moveAction.run(p);
  });

  _kaboom.default.action('blackBird', function (p) {
    blackBirdFly.run(p);
  });
  ...
  _kaboom.default.loop(1, function () {
    var lv = 0;
    ...
    if (loop.value >= 8 && _kaboom.default.rand(0, 1) > 0.80 - score.value / 100) {
      if (_kaboom.default.rand(0, 1) > 0.85) {
        spawnBird();
      } else {
        spawnBee();
      }
...
function deathScene(that, score) {
  ...
  _kaboom.default.wait(2, function () {
    _kaboom.default.go('sceneDeath', score.value);
  });
}
...
function countScore(score) {
  ...
  _kaboom.default.play('archive', {
    volume: 0.4
  });
}

function addScore() {
  return _kaboom.default.add([_kaboom.default.text('0', 16), _kaboom.default.layer('ui'), _kaboom.default.pos(9, 9), {
    value: 0
  }]);
}

function spawnBird() {
  var h1 = _kaboom.default.rand(PIPE_MIN_HEIGHT, _kaboom.default.height() - PIPE_MIN_HEIGHT - PIPE_OPEN);

  var blackBirdFly = _kaboom.default.add([(0, _common.tileMap)().blackBird, _kaboom.default.area(_kaboom.default.vec2(6), _kaboom.default.vec2(24, 19)), _kaboom.default.pos(_kaboom.default.width(), h1), 'blackBird', {
    defaultPos: {
      x: _kaboom.default.width(),
      y: h1
    }
  }]);
...
function spawnBee() {
  ...
  var blackBee = _kaboom.default.add([(0, _common.tileMap)().blackBee, _kaboom.default.area(_kaboom.default.vec2(6), _kaboom.default.vec2(22, 16)), _kaboom.default.pos(_kaboom.default.width(), h1), 'blackBird', {
    flySpeed: 0.005,
    moveSpeed: 1.5,
    defaultPos: {
      x: _kaboom.default.width(),
...
function spawnPipe(level) {
  var yMiddlePosition = _kaboom.default.height() / 2;
  var tempP = _kaboom.default.height() / 4;

  var h1 = _kaboom.default.rand(yMiddlePosition - tempP, yMiddlePosition + tempP - PIPE_OPEN);

  var h2 = h1 + PIPE_OPEN;

  if (level >= 1) {
    _kaboom.default.add([_kaboom.default.sprite('brick'), _kaboom.default.origin('botleft'), _kaboom.default.pos(_kaboom.default.width(), h1), 'pipe']);

    _kaboom.default.add([_kaboom.default.sprite('pipe'), _kaboom.default.origin('topleft'), _kaboom.default.pos(_kaboom.default.width(), h2), 'pipe']);
  }

  var coins = [(0, _common.tileMap)().goldCoin, (0, _common.tileMap)().heart, (0, _common.tileMap)().bigGoldCoin];

  var coinSprite = _kaboom.default.choose(coins);

  _kaboom.default.add([coinSprite, _kaboom.default.origin('botleft'), _kaboom.default.pos(_kaboom.default.width(), h1 + PIPE_OPEN / 2), 'point']);
}
},{"../actions/birdFly":"S9JN","../actions/moveAction":"ZG0O","../kaboom":"Snzt","./common":"FZQ6"}],"mL5u":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = sceneDeath;
...
function sceneDeath(score) {
  (0, _common.addBackground)();

  _kaboom.default.add([_kaboom.default.text("".concat(score), 20), _kaboom.default.pos(_kaboom.default.width() / 2, _kaboom.default.height() / 2), _kaboom.default.origin('center')]);

  _kaboom.default.add([_kaboom.default.text("Press Space!", 8), _kaboom.default.pos(_kaboom.default.width() / 2, _kaboom.default.height() / 2 - 20), _kaboom.default.origin('center')]);

  var birdy = (0, _common.addBirdy)({
    flySpeed: flySpeed,
    isSolid: true
  });
  birdy.pos.x = _kaboom.default.width() / 2 - 10;
  birdy.pos.y = _kaboom.default.height() / 2 + 20;
  setTimeout(function () {
    _kaboom.default.keyPress('space', function () {
      _kaboom.default.go('main');
...
;
},{"../kaboom":"Snzt","./common":"FZQ6"}],"N5a8":[function(require,module,exports) {
"use strict";
...
function welcomeScene() {
  ...
  birdy.pos.x = _kaboom.default.width() / 2 - 10;
  birdy.pos.y = _kaboom.default.height() / 2;
...
;
},{"../kaboom":"Snzt","./common":"FZQ6"}],"epB2":[function(require,module,exports) {
"use strict";

var _kaboom = _interopRequireDefault(require("./kaboom"));

var _mainScene = _interopRequireDefault(require("./scenes/mainScene"));

var _sceneDeath = _interopRequireDefault(require("./scenes/sceneDeath"));

var _welcomeScene = _interopRequireDefault(require("./scenes/welcomeScene"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_kaboom.default.loadSprite('bg', './bg.png');

_kaboom.default.loadSprite('birdy', './birdy.png');

_kaboom.default.loadSprite('honey', './honey.png', {
  sliceX: 2,
  sliceY: 0,
  anims: {
    fly: {
...
_kaboom.default.loadSprite('pipe', './pipe.png');

_kaboom.default.loadSprite('brick', './brick.png');

_kaboom.default.loadSprite('tileMap', './tilemap.png', {
  sliceX: 30,
  sliceY: 30,
  anims: {
    blackBirdFly: {
...
_kaboom.default.loadSound('archive', './sounds/archive.mp3');

_kaboom.default.loadSound('jump', './sounds/jump.mp3');

_kaboom.default.loadSound('bgMusic', './sounds/Upbeat-Background-Music.mp3');

_kaboom.default.scene('sceneDeath', _sceneDeath.default);

_kaboom.default.scene('main', _mainScene.default);

_kaboom.default.scene('welcomeScene', _welcomeScene.default);

_kaboom.default.start('welcomeScene');
},{"./kaboom":"Snzt","./scenes/mainScene":"JjTe","./scenes/sceneDeath":"mL5u","./scenes/welcomeScene":"N5a8"}]},{},["epB2"], null)
//# sourceMappingURL=/main.1a4cd25b.js.map